  ...
  return (
    ...
    >
      <div className="relative overflow-hidden aspect-[4/5]">
        ...
        {/* category badge */}
        <span className="absolute top-2.5 left-2.5 bg-primary/90 text-highlight text-[9px] font-extrabold uppercase tracking-wider px-2 py-0.5 rounded-r-md rounded-tl-md shadow-sm backdrop-blur-sm">
          {design.category}
        </span>
