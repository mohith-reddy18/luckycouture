 ...
 * - The fee strictly increases as order value increases (monotonically increasing).
 * - Authoritatively computed on the backend.
 * - Formatted/rounded to 2 decimal places (standard currency cents/paise).
 *
